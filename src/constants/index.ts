export const SITE_CONFIG = {
  ...
  checkoutUrl: 'https://pay.kiwify.com.br/6hK1S0P',
  guaranteeDays: 7,
};
...
export const FAQ = [
  ...
  },
  {
    ...
    answer:
      'Imediatamente após a confirmação do pagamento, você recebe um e-mail com o link de acesso ao material completo, que pode ser lido no computador, tablet ou celular.',
  },
  {
    question: 'Tem garantia?',
    answer:
      'Sim. Você tem 7 dias de garantia incondicional. Se o material não fizer sentido para você, basta solicitar o reembolso e devolvemos 100% do seu investimento.',
  },
  {
