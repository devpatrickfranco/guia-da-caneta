  ...
  return (
    <section id="recebe" className="py-16 sm:py-24 relative">
      ...
      <Container>
        <SectionTitle
          tag="tudo incluso"
          title="Tudo isso incluso no seu acesso"
          description="Material completo + bônus exclusivos para você começar com o pé direito."
        />
              ...
              <div className="flex items-start gap-4 sm:gap-6">
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <p className="text-muted-foreground mt-2 leading-relaxed">
                    Guia completo com tudo o que você precisa saber antes de começar o
                    tratamento com canetas de emagrecimento. Inclui entregáveis
        ...
        <div className="mt-12 sm:mt-16">
          <h3 className="text-center text-lg font-semibold text-muted-foreground mb-8">
            + <span className="text-primary font-bold">3 bônus exclusivos</span> incluídos
          </h3>
