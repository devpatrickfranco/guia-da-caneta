  ...
  return (
    <section id="erros" className="py-16 sm:py-24 relative">
      ...
      <Container>
        <SectionTitle
          tag="erros comuns"
          title="Os erros que podem custar caro no seu tratamento"
          description="Pequenos deslizes que comprometem resultados e fazem você perder tempo, dinheiro e motivação."
        />
